...
extension NewsViewController:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == collectionViewHeader{
            ...
            cell.titleColor1 = .white
            cell.selectionColor = Colors.backColor()
            cell.deSelectionColor = .clear
            cell.titleColor2 = Colors.gray1Color()
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if collectionView == collectionViewHeader{
            ...
            return CGSize(width: w, height: 250)
                ...
                let h = UIScreen.main.bounds.height - 250
