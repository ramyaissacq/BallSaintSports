...
class SideMenuViewController:BaseViewController{
    ...
    func sendEmail() {
        if MFMailComposeViewController.canSendMail() {
            ...
            mail.setToRecipients(["lockery.smith@gmail.com"])
...
extension SideMenuViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1:
            ...
            Utility.openUrl(url: URL(string: "https://ballsaintsports.wordpress.com/2022/11/12/privacy-policy/")!)
        case 2:
            Utility.shareAction(text: "Install Ball Saint Sports from apple appstore", url:URL(string: "") , image: UIImage(named: "launch"), vc: self.parent!)
            
        case 3:
            sendEmail()
            
        case 4:
            Utility.rateApp(id: "6444821949")
