...
extension HomeViewController:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == collectionViewTime{
            ...
            cell.configureCell(unselectedViewColor: .clear, selectedViewColor: Colors.greenNewColor(), unselectedTitleColor: Colors.gray1Color(), selectedTitleColor: .white, title: viewModel.categories[indexPath.row])
            return cell
        }
...
extension HomeViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if selectedTimeIndex == 2{
            let cell = tableView.dequeueReusableCell(withIdentifier: "scheduleMatchTableViewCell") as! ScheduleMatchTableViewCell
